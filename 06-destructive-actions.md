...
> **Project CLAUDE.md can override this entire section.** See `00-project-overrides.md`.
> If CLAUDE.md grants autonomous execution → skip all confirmations below.
> The "NEVER Do" hard block above is NOT overridable.

These require a plain-language explanation and user confirmation (when no override is active):
