...
> **Project CLAUDE.md can override these rules.** See `00-project-overrides.md`.
> If the project's CLAUDE.md grants autonomous execution → skip all confirmation steps below.
