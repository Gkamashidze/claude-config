...
> Active for: React, Next.js, Vue, Svelte, HTML/CSS — any project with `.tsx`, `.jsx`, `.vue`, `.html`, `.css` files.
> **SKIP ENTIRELY for:** Telegram bots, CLI tools, pure backend APIs, Python scripts, data pipelines.
