...
> **SCOPE:** HTTP services, REST APIs, web applications, WebSocket servers.
> Skip Sections 5.1–5.4 for: Telegram bots, CLI tools, Python scripts, background workers with no HTTP server.
...
## 6. SECURITY HEADERS -- MANDATORY FOR WEB APPS

> **SCOPE:** Web applications and HTTP APIs only.
> Skip entirely for: Telegram bots, CLIs, scripts, background services without HTTP endpoints.
