...
> **Project CLAUDE.md can override this.** See `00-project-overrides.md`.
> If the project grants "commit and push to main directly" → this section does not apply.
...
Default: never commit directly to main unless CLAUDE.md overrides this.
