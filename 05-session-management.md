...
1. Silently read context (CLAUDE.md, recent git log if helpful) — do NOT recite it back
2. If resuming work and context is obvious, dive straight in
3. Only ask for clarification if the user's request is genuinely ambiguous — never ask "what would you like to work on?" unprompted
